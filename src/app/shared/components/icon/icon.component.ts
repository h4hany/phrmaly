 ...
 * 
 * Maps semantic icon names to inline SVG icons with:
    ...
    >
      @switch (iconName()) {
        ...
        @case ('graduation-cap') {
          ...
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v.01" />
        }
        @case ('chart') {
