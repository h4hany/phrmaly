      ...
      <div class="container">
        <div class="left-panel">
          ...
          <div class="welcome-text">
            <h1>System Console Access</h1>
            <p>Platform administration and management portal for Super Admins.</p>
            <p>Manage accounts, subscriptions, support tickets, and platform-wide settings.</p>
          </div>
          ...
          <div class="features">
            ...
            <div class="feature-item">
              <div class="feature-icon"></div>
              <span>Global drug catalog management</span>
            </div>
          </div>
        </div>
        ...
        <div class="right-panel">
          <div class="login-header">
            <h2>Admin Sign In</h2>
            <p>Enter your admin credentials to access the System Console</p>
          </div>
          ...
          <div class="divider">
            <span>Pharmacy User?</span>
          </div>

          <div class="signup-link">
            <a [routerLink]="['/login']">Switch to Pharmacy Login</a>
          </div>
        </div>
      </div>
    </div>
